...
public class Dessert extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// stmt.executeUpdate("CREATE TABLE Product (ProductId int NOT NULL,ProductName varchar(50) NOT NULL,ProductDescription varchar(200) NOT NULL,ProductPrice int NOT NULL,ProductPicture varchar(100) NOT NULL,ProductStatus int NOT NULL,UserId int NOT NULL )");
