...
public class Dessert extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			stmt.executeUpdate("CREATE TABLE Booking (BookingId int(11) NOT NULL, BookingDated varchar(15) NOT NULL, ProductId int(11) NOT NULL, UserId int(11) NOT NULL ) ENGINE=InnoDB DEFAULT CHARSET=latin1");
